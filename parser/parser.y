...
|	TableRef CrossOpt TableRef "ON" Expression
	{
		...
		$$ = &ast.Join{Left: $1.(ast.ResultSetNode), Right: $3.(ast.ResultSetNode), On: on, Tp: ast.CrossJoin}
	}

|	TableRef JoinType OuterOpt "JOIN" TableRef "ON" Expression
	{
		on := &ast.OnCondition{Expr: $7}
		$$ = &ast.Join{Left: $1.(ast.ResultSetNode), Right: $5.(ast.ResultSetNode), On: on, Tp: $2.(ast.JoinType)}
	}
